...
function Testimonials(props) {
    ...
    return (
        <section className="pro-pac-section pro-pac-section-testimonial">
            <div className="pro-pac-testimonial-heading pro-pac-text-black pro-pac-fw-500 pro-pac-f-48">
                <div>Hear, what others </div>
                <div className="pro-pac-text-pink pro-pac-fw-700">have to say</div>
            </div>
            <div className="pro-pac-slider-container">
                <Slider {...settings}>
                    {
                        testimonial.map((item, idx) => {
                            return (
                                <div className="pro-pac-outer-testimonial-card" key={idx}>
                                    <div className="pro-pac-testimonial-card">
                                        <div className="pro-pac-testimonial-card-top">
                                            <div className="pro-pac-tct-l">
                                                <div className="pro-pac-tct-icon" style={item.iconStyle}>
                                                    {item.name.charAt(0)}
                                                </div>
                                                <div className="pro-pac-tct-about">
                                                    <div className="pro-pac-tct-name">{item.name}</div>
                                                    <Star count={item.star} />
                                                </div>
                                            </div>
                                            <div className="pro-pac-tct-r">
                                        ...
                                        <div className="pro-pac-testimonial-card-bottom">
                                            {item.message}
                                        </div>
                                    </div>
                                </div>
