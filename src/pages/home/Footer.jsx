...
function Footer(props) {
    return (
        <section className="pro-pac-section pro-pac-section-footer">
            <div className="pro-pac-footer">
                <div className="pro-pac-footer-sec pro-pac-footer-sec1">
                    <h4 className="pro-pac-footer-sec-heading">Other Links</h4>
                    <div className="pro-pac-footer-sec-links">
                ...
                <div className="pro-pac-footer-sec pro-pac-footer-sec2">
                    <h4 className="pro-pac-footer-sec-heading">Social Links</h4>
                    <div className="pro-pac-footer-sec-links pro-pac-">
                        <NavLink className="pro-pac-social-links" to={"/"}>
                ...
                <div className="pro-pac-footer-sec pro-pac-footer-sec3">
                    <h4 className="pro-pac-footer-sec-heading">Contact Us</h4>
                    <div className="pro-pac-footer-sec-links">
                        <p className="pro-pac-footer-email">
                            support@tutedude.com
                        </p>
                        <p className="pro-pac-footer-phone">
                            +91 7988800474
                        </p>
                    </div>
                </div>
                <div className="pro-pac-footer-sec pro-pac-footer-sec4">
                    <h4 className="pro-pac-footer-sec-heading">Registered Office</h4>
                    <div className="pro-pac-footer-sec-links">
                        <div className="pro-pac-footer-address">
