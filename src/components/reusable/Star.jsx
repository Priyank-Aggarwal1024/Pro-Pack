...
function Star({ count }) {
    return (
        <div className='pro-pac-star-div'>
            {
                count.map((item, idx) => {
                    return (
                        <div className="pro-pac-star" key={idx}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                                <rect width="25.2642" height="25.2642" transform="translate(0.130859 0.45166)" fill="url(#paint0_linear_23_1545)" />
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_23_1545" x1="0" y1="12.6321" x2="25.2642" y2="12.6321" gradientUnits="userSpaceOnUse">
